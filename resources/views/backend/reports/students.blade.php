                ...
                <div id="academic_fields" class="hidden">
                 ...
                 <div class="md:flex md:items-center mb-6">
                  ...
                  <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3 block text-gray-600 font-bold">
                        <select name="status" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="level" >
                            <option value="">--Select Status--</option>
                            <option value="Completed">Kasoa</option>
