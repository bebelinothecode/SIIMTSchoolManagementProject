...
<div class="roles">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-gray-700 uppercase font-bold">Defaulters  List</h2>
        </div>
    ...
    <div class="table w-full mt-8 bg-white rounded">
        <form action="{{ route('get.defaulters') }} " method="GET" class="w-full max-w-xl px-6 py-12" enctype="multipart/form-data" target="_blank">
            @csrf
            ...
            {{-- Level --}}
            <div class="md:flex md:items-center mb-6" id="level-html" style="display:none;">
                <div class="md:w-1/3">
                    <label class="block text-gray-500 font-bold md:text-right mb-1 md:mb-0 pr-4">
                        Level
                    </label>
