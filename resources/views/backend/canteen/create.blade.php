        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('canteen.store') }} " method="POST" class="w-full max-w-xl px-6 py-12" enctype="multipart/form-data">
                ...
                <div class="md:flex md:items-center mb-6">
                    ...
                    <div class="md:w-2/3">
                        <div class="md:w-2/3">
                            <select name="category" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="bought_forms" required>
                    ...
                    <div class="md:flex md:items-center mb-6">
                        ...
                        <div class="md:w-2/3">
                            <div class="md:w-2/3">
                                <select name="mode_of_transaction" class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="mode_of_transaction">
                                    <option value="">-- Select currency --</option>
