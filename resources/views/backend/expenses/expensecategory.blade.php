...
<div class="container mx-auto mt-6">
    <h1 class="text-2xl font-bold text-gray-700">Expense Category List</h1>

    @hasrole('Admin|rector|AsstAccount')
    <!-- Add Expense Button -->
    <div class="flex flex-wrap items-center mt-4">
        <a href="{{ route('create.expensecategoryform') }}" class="bg-gray-200 text-gray-700 text-sm uppercase py-2 px-4 flex items-center rounded">
            ...
            <span class="ml-2 text-xs font-semibold">Expense Category</span>
        </a>
    </div>
    @endhasrole
        ...
        <table class="w-full table-auto">
            ...
            <tbody class="text-gray-600 text-sm font-light">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    <td class="py-3 px-6 text-left whitespace-nowrap">{{ $category->expense_category }}</td>
                    ...
                    <td class="py-3 px-6 text-center">
                            ...
                            <a href="{{ route('edit.expensecategoryform',$category->id) }} " class="text-blue-600 hover:underline">Edit</a> 
                            <form action="{{ route('delete.expensecategory',$category->id) }} " method="POST" onsubmit="return confirm('Are you sure you want to delete this expense?');" class="inline">
                                @csrf
                                @method('DELETE')
