            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div class="space-y-2">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900">Record New Leave</h1>
                            <p class="text-sm text-gray-500 mt-1">Add a new leave record for staff member</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <select name="status" id="status"
                            ...
                            <option value="approved" {{ old('status') === 'approved' ? 'selected' : '' }} class="text-green-600">Approved</option>
                            <option value="rejected" {{ old('status') === 'rejected' ? 'selected' : '' }} class="text-red-600">Rejected</option>
                        </select>
                        @error('status')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <textarea name="reason" id="reason" rows="4"
                                      ...
                                      placeholder="Enter the reason for leave" required>{{ old('reason') }}</textarea>
                        </div>
                        @error('reason')
                            <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
                        @enderror
