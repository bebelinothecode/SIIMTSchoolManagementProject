...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Delete Assigned Subject to Teacher</h2>
            </div>
        ...
        <div class="table w-full mt-8 bg-white rounded">
            <form action="{{ route('delete.assigned',['id'=> $teacher->id]) }}" method="POST" class="w-full max-w-xl px-6 py-12" enctype="multipart/form-data">
                @method('DELETE')   
                @csrf
